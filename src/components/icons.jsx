// Minimal stroke-based icon set (24x24 viewBox, lucide-style paths).
const PATHS = {
  // Connected nodes — used as the app logo
  network: (
    <>
      <circle cx="5" cy="12" r="2.5" />
      <circle cx="19" cy="5" r="2.5" />
      <circle cx="19" cy="19" r="2.5" />
      <line x1="7.3" y1="10.9" x2="16.8" y2="6.1" />
      <line x1="7.3" y1="13.1" x2="16.8" y2="17.9" />
    </>
  ),
  route: (
    <>
